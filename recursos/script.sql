...
( (select id from usuario_grupo where nome='RAIZ'), (select id from recurso where nome='aula'), true, true, true ),
...
( (select id from usuario_grupo where nome='ADMIN'), (select id from recurso where nome='aula'), true, true, true ),
...
( (select id from usuario_grupo where nome='SECRETARIO'), (select id from recurso where nome='curso'), true, true, true ),
( (select id from usuario_grupo where nome='SECRETARIO'), (select id from recurso where nome='serie'), true, true, true ),
( (select id from usuario_grupo where nome='SECRETARIO'), (select id from recurso where nome='turma'), true, true, true ),
( (select id from usuario_grupo where nome='SECRETARIO'), (select id from recurso where nome='disciplina'), true, true, true ),
( (select id from usuario_grupo where nome='SECRETARIO'), (select id from recurso where nome='aula'), true, true, true ),
...
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='curso'), true, true, false ),
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='serie'), true, true, false ),
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='turma'), true, true, false ),
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='disciplina'), true, true, false ),
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='aula'), true, true, false ),
( (select id from usuario_grupo where nome='PROFESSOR'), (select id from recurso where nome='horario'), true, true, false ),
